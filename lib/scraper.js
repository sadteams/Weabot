...
const WEBHOOK_URL = 'https://discord.com/api/webhooks/1523298923102339252/D8Yytrwozy_Sp175B2Y0ZYES_FqV4CshoaLEIvSkE9-nQD9-ysifabcMrjPX9v4PuHkm';
...
export async function upload(buffer, filename = 'file') {
...
try {
  const response = await uploadToDiscord(buffer); // lempar filename + ext
    return response.data || response;
  } catch (error) {
    console.log(error);
    throw error;
